            ...
            <div class="mb-3">
                <form action="crear_item.jsp" method="post">
                    <button class="btn btn-success">
                        <i class="fa-solid fa-add" style="color: #ffffff;"></i> Nuevo Item
                    </button>
                </form>
            </div> 
                    ...
                    <div class="card mb-4 p-4">
                        <div class="row no-gutters">
                            ...
                            <div class="card-body text-center">
                                ...
                                <p class="card-text">Stock </p><h1>20 KG</h1>
                                <form action="modificar_item.jsp" method="post" style="display:inline;">
                                    <input type="hidden" name="id" value="1">
                                    <button class="btn btn-warning">
                                        <i class="fa-solid fa-edit" style="color: #000000;"></i> Modificar
                                    </button>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="card mb-4 p-4">
                        <div class="row no-gutters">
                            ...
                            <div class="card-body text-center">
                                ...
                                <p class="card-text">Stock </p><h1>20 UND</h1>
                                <form action="modificar_item.jsp" method="post" style="display:inline;">
                                    <input type="hidden" name="id" value="1">
                                    <button class="btn btn-warning">
                                        <i class="fa-solid fa-edit" style="color: #000000;"></i> Modificar
