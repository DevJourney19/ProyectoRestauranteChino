			...
			<div class="container">
				<div class="mb-3">
					<div
						...
						<span class="fs-3 numero-productos"><%=listaMenu.size()%>
							items</span>
					</div>
				</div>

				<!-- Carrusel de productos -->
				<div id="menuCarouselXl" class="carousel slide d-none d-xl-block"
								...
								<div class="col-12 col-xl-4 col-xxl-4">
									<div class="card mb-5">
										<div class="row g-0">
											<div class="col-md-4">
												<img
													src="data:<%=menus.getTipoImagen()%>;base64,<%=menus.getImagen()%>"
													class="img-menu m-2 rounded-start"
													alt="<%=menus.getNombre()%>">
											</div>
											<div class="col-md-8">
												<div class="card-body">
										...
										<div class="card-footer bg-transparent">
											<div class="d-flex justify-content-between align-items-start">
												...
												<h5>
													<span
														class="badge bg-primary mt-3 rounded-pill <%=estadoClass%>"><%=estadoMenu%></span>
												</h5>
											</div>
										</div>
									</div>
					...
					<button class="boton bg-dark carousel-control-prev" type="button"
						data-bs-target="#menuCarouselXl" data-bs-slide="prev"
						style="width: 50px;">
						<span class="carousel-control-prev-icon" aria-hidden="true"></span>
						<span class="visually-hidden">Previous</span>
					</button>
					<button class="boton bg-dark carousel-control-next" type="button"
						data-bs-target="#menuCarouselXl" data-bs-slide="next"
						style="width: 50px;">
				...
				<!-- Carrusel de productos -->
				<div id="menuCarousel" class="carousel slide d-block d-xl-none"
